	...
	<div class="row">
		...
		<div class="col-md-4">
			<form>
				...
				<address>
					<strong>Shopit, Inc.</strong><br> Jinnah Avenue street 12,
					Suite 600<br> Karachi, KHI 74200<br> <abbr title="Phone">
					</abbr> 021-(123) 456-7890
				</address>
				<address>
					<strong>Shopit</strong><br> <a href="mailto:#">contact@shopit.com</a>
				</address>
			</form>
		</div>
	</div>
